 ...
 *     <li>Все методы, принимающие вершину по числовому id, ожидают id в диапазоне {@code [0, getVertices().size())}.
 *         В случае некорректного id, в зависимости от реализации, методы будут возвращать {@code false} или {@link IllegalArgumentException}.</li>
 * </ul>
 *
 ...
 *     <li>Выберите внутреннее представление.</li>
 ...
 *             <li>{@link #getParents(int)} / {@link #getChildren(int)} — доступ к списку предков и потомков конкретной вершины;</li>
 ...
 * два графа равны, если у них совпадает количество вершин и для каждой вершины совпадает отсортированный список детей с точностью до индексов.
 * </p>
 *
 * <ul>
