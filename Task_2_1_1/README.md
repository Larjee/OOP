...
в секундах для разных реализаций алгоритма поиска составного числа.
### bigSizeBigData
...
На графиках также указаны доверительные интервалы 95%. 

## Итог исследования
Как и ожидалось, последовательный(`Sequential`) алгоритм будет значительно проигрывать своим многопоточным братьям.

Рассмотрим реализацию `Threads`. Как видно из графиков, на достаточно больших массивах хорошо проглядывается прирост в 
...
ParallelStream. Так что лучше всего использовать реализацию `Threads`.
